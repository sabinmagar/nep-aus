<?php
    ...
    if ( ! function_exists( 'nepal_australia_news_breadcrumb' ) ) {
        function nepal_australia_news_breadcrumb ( $list_style = 'ul', $list_id = 'breadcrumb', $list_class = 'breadcrumbs bg-light mb-4', $active_class = 'breadcrumbs__item breadcrumbs__item--current', $echo = false ) {
            ...
            if ( is_front_page() ) {
                ...
                $breadcrumb .= '<li class="breadcrumbs__item"><a class="class="breadcrumbs__url" href="' . home_url() . '"><i class="fa fa-home"></i> होमपेज</a></li>';
            }
            ...
            if ( is_singular( 'post' ) ) {
                ...
                // if ( $post_cats[0] ) {
                //     $breadcrumb .= '<li class="breadcrumbs__item"><a href="' . get_category_link( $post_cats[0]->term_id ) . '">' . $post_cats[0]->name . '</a></li>';
                // }
